...
class TouchIdSpendingLimitViewController : UITableViewController, Subscriber {
    ...
    private let limits: [UInt64] = [0, 100000000, 500000000, 2500000000, 10000000000, 100000000000, 250000000000, 1000000000000, 10000000000000]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        amount.constrain([amount.heightAnchor.constraint(equalToConstant: 0.0)])
