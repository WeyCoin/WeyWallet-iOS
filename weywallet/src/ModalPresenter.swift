...
class ModalPresenter : Subscriber, Trackable {
    ...
    private func presentSettings() {
        ...
        let sections = ["Wallet", "Manage", "WeyWallet", "Advanced"]
        var rows = [
        ...
        if BRAPIClient.featureEnabled(.earlyAccess) {
            rows["WeyWallet"]?.insert(Setting(title: S.Settings.earlyAccess, callback: {
                settingsNav.dismiss(animated: true, completion: {
        ...
        rows["WeyWallet"]?.append( Setting(title: S.Settings.review, callback: {
