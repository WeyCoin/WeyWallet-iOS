...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/weycoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/weycoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/weycoin-paymentack" && data.count <= 50000 {
